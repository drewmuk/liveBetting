...
currentMOV <- .769816286850381
currenttotal <- .987006417644204
interceptM <- .00511057155380426
interceptO <- -20.8238866932076
OU <- .487241252193598
totalsecleft <- -.000478209130245962
totalSecleft <- .0130492407756135
                        ...
                        minutes, yardLine, fieldSide, down, ydsToGo, pTO, dTO) 
{
  ...
  data <- tibble::tibble(
    ...
    "posteam" = "BAL",
    "roof" = "outdoors",
    "half_seconds_remaining" = secLeft,
